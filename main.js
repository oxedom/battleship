...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"gameboard\": () => (/* binding */ gameboard)\n/* harmony export */ });\n/* harmony import */ var _pubsub__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../pubsub */ \"./src/js/pubsub.js\");\n/* harmony import */ var _state__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../state */ \"./src/js/state.js\");\n\n\n\n\nconst gameboard = () => {\n    let board = document.createElement('div')\n    board.classList.add('gameboard')\n    board.classList.add('red')\n    let cellID = 1\n    let column = 1\n    const firstBoardBuilt = _state__WEBPACK_IMPORTED_MODULE_1__.stateObject.getplayerBoardBuilt()\n    for (let index = 0; index < 10; index++) {\n\n        for (let j = 0; j < 10; j++) {\n            let cell = document.createElement('div')\n            cell.classList.add('cell')\n\n            if (!firstBoardBuilt) {\n                cell.addEventListener('click', (e) => { _pubsub__WEBPACK_IMPORTED_MODULE_0__.pubsub.publish('cellClicked', e) })\n                cell.setAttribute('id', cellID)\n            }\n\n            cell.setAttribute('row', index + 1)\n            cell.setAttribute('column', column)\n            column++\n            cellID++\n            if (column > 10) {\n                column = 1\n\n            }\n            board.append(cell)\n        }\n\n\n    }\n    _pubsub__WEBPACK_IMPORTED_MODULE_0__.pubsub.publish('playerBoardInit')\n    _pubsub__WEBPACK_IMPORTED_MODULE_0__.pubsub.publish('updatePlayerBoard')\n    return board\n\n\n}\n\n//# sourceURL=webpack://battleship/./src/js/comps/gameboardComp.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"dom\": () => (/* binding */ dom)\n/* harmony export */ });\n/* harmony import */ var _styles_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styles.css */ \"./src/js/styles.css\");\n/* harmony import */ var _pubsub__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./pubsub */ \"./src/js/pubsub.js\");\n/* harmony import */ var _state__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./state */ \"./src/js/state.js\");\n\n\n\n\nconst dom = (function () {\n\n    _pubsub__WEBPACK_IMPORTED_MODULE_1__.pubsub.subscribe('paintCells', paintCells)\n    _pubsub__WEBPACK_IMPORTED_MODULE_1__.pubsub.subscribe('paintingComplete', pantingComplete)\n\n    function pantingComplete() {\n        let shipToRemove = document.getElementById(`ship_${_state__WEBPACK_IMPORTED_MODULE_2__.stateObject.getSelectedShip()}`)\n        shipToRemove.style = \"display: none\"\n        _pubsub__WEBPACK_IMPORTED_MODULE_1__.pubsub.publish('removedShip', undefined)\n    }\n\n\n    function paintCells(cellID) {\n\n        let cell = document.getElementById(cellID)\n\n        let shipLength = _state__WEBPACK_IMPORTED_MODULE_2__.stateObject.getSelectedShip()\n\n        if (cell.classList.contains('cellected')) { return }\n        if (shipLength != 1) {\n            if (cell.nextElementSibling.classList.contains('cellected') && _state__WEBPACK_IMPORTED_MODULE_2__.stateObject.getDirection() == 'row') { return }\n            if (document.getElementById(`${parseInt(cellID) + 10}`).classList.contains('cellected') && _state__WEBPACK_IMPORTED_MODULE_2__.stateObject.getDirection() == 'column') { return }\n        }\n\n        if (_state__WEBPACK_IMPORTED_MODULE_2__.stateObject.getDirection() === 'row') {\n            cell.classList.add('cellected')\n            cell.setAttribute('marked', true)\n            for (let index = 1; index < shipLength; index++) {\n                cell = cell.nextElementSibling\n                cell.classList.add('cellected')\n            }\n        }\n        if (_state__WEBPACK_IMPORTED_MODULE_2__.stateObject.getDirection() === 'column') {\n\n            let tempCellID = parseInt(cellID)\n\n            for (let index = 0; index < shipLength; index++) {\n                console.log(tempCellID);\n                let tempCell = document.getElementById(`${tempCellID}`)\n                tempCell.classList.add('cellected')\n                tempCellID = tempCellID + 10\n\n            }\n\n\n        }\n        _pubsub__WEBPACK_IMPORTED_MODULE_1__.pubsub.publish('paintingComplete')\n    }\n\n\n\n\n    function cleanCells(cellCords) { document.querySelectorAll('.cell').forEach(cell => cell.classList.remove('cellected')) }\n\n\n\n\n\n    return {};\n})();\n\n\n//# sourceURL=webpack://battleship/./src/js/dom.js?");
