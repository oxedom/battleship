...
const GameboardFactory = () => {
  ...
  const createRandom = (times) => {
    ...
    if (!checkLegalMove(parsedIndex.y, parsedIndex.x, times, "row")) {
      return createRandom(times);
    }
    return arr;
  };
